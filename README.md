# Prova prática Android — Biblioteca (Java)
...
> Existe uma versão equivalente desta prova em **Kotlin**, com exatamente as
...
| `Main.java` | O laço do terminal e o despacho dos comandos |
...
2. **Toda impressão passa pelo `Console`.** Nos comandos novos, chame os
   métodos dele em vez de `System.out.println` direto.
